...
#define DEFVAL_gs 1.17571287633
...
#undef COUPLING_COMMAND
  ...
  std::string getCouplingName(LexiConHCCouplings::Amplitude_JHUGen_Include_Triple_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::EFT_JHUGen_Include_Triple_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::HiggsBasis_Include_Triple_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::EFT_HiggsBasis_Include_Triple_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::Amplitude_JHUGen_Charged_Current_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::Amplitude_JHUGen_Neutral_Current_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::Amplitude_JHUGen_Include_Triple_Charged_Current_CouplingType type);
  std::string getCouplingName(LexiConHCCouplings::Amplitude_JHUGen_Include_Triple_Neutral_Current_CouplingType type);
}
